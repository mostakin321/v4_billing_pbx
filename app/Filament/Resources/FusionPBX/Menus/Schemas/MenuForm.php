...
namespace App\Filament\Resources\FusionPBX\Menus\Schemas;
            ...
            Tabs::make('Menu')
                ...
                ->tabs([
                    ...
                    TextInput::make('menu_name')
                        ->label('Menu Name')->placeholder('menu name'),
                    Textarea::make('menu_description')
                        ->label('Menu Description')->rows(2)->columnSpanFull(),
                                ]),
                        ]),
                    ...
                    Tabs\Tab::make('Audio')
                        ...
                        ->schema([
                            Section::make('Audio')
                                ->columns(2)
                                ->schema([
                    TextInput::make('menu_language')
                        ->label('Menu Language')->placeholder('en'),
                                ]),
                        ]),
                ]),
