...
namespace App\Filament\Resources\FusionPBX\Bridges\Schemas;
                    ...
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('bridge_name')
                        ->label('Bridge Name')->placeholder('bridge name'),
                    TextInput::make('bridge_destination')
                        ->label('Bridge Destination')->placeholder('bridge destination'),
                    Select::make('bridge_enabled')
                        ->label('Bridge Enabled')
                        ->native(false)->options(['true'=>'Yes','false'=>'No'])->default('false'),
                    Textarea::make('bridge_description')
                        ->label('Bridge Description')->rows(2)->columnSpanFull(),
                                ]),
                        ]),
                ]),
