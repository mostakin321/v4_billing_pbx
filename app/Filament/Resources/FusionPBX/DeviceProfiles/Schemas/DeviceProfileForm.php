...
namespace App\Filament\Resources\FusionPBX\DeviceProfiles\Schemas;
                    ...
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('device_profile_name')
                        ->label('Profile Name')->placeholder('profile name'),
                    Select::make('device_profile_enabled')
                        ->label('Profile Enabled')
                        ->native(false)->options(['true'=>'Yes','false'=>'No'])->default('false'),
                    Textarea::make('device_profile_description')
                        ->label('Profile Description')->rows(2)->columnSpanFull(),
                                ]),
                        ]),
                ]),
