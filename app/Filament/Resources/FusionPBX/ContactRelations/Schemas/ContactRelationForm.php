...
namespace App\Filament\Resources\FusionPBX\ContactRelations\Schemas;
...
class ContactRelationForm
{
    public static function configure(Schema $form): Schema
    {
        return $form->schema([

            Tabs::make('Contact Relation')
                ->columnSpanFull()
                ->tabs([
                    Tabs\Tab::make('Main')
                    ...
                    TextInput::make('relation_label')
                        ->label('Relation Label')->placeholder('relation label'),
                                ]),
                        ]),
                ]),
