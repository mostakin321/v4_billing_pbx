...
namespace App\Filament\Resources\FusionPBX\EmailTemplates\Schemas;
            ...
            Tabs::make('Email Template')
                ...
                ->tabs([
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('template_category')
                        ->label('Template Category')->placeholder('template category'),
                    TextInput::make('template_subcategory')
                        ->label('Template Subcategory')->placeholder('template subcategory'),
                    TextInput::make('template_subject')
                        ->label('Template Subject')->placeholder('template subject'),
                    TextInput::make('template_body')
                        ->label('Template Body')->placeholder('template body'),
                    TextInput::make('template_type')
                        ->label('Template Type')->placeholder('template type'),
                    Select::make('template_enabled')
                        ->label('Template Enabled')
                        ->native(false)->options(['true'=>'Yes','false'=>'No'])->default('false'),
                    Textarea::make('template_description')
                        ->label('Template Description')->rows(2)->columnSpanFull(),
                                ]),
                        ]),
                    ...
                    TextInput::make('template_language')
                        ->label('Template Language')->placeholder('en'),
                                ]),
                        ]),
                ]),
