...
namespace App\Filament\Resources\FusionPBX\IvrMenuOptions\Schemas;
...
class IvrMenuOptionForm
{
    public static function configure(Schema $form): Schema
    {
        return $form->schema([

            Tabs::make('Ivr Menu Option')
                ->columnSpanFull()
                ->tabs([
                    Tabs\Tab::make('Main')
                    ...
                    TextInput::make('ivr_menu_option_digits')
                        ->label('Option Digits')->placeholder('option digits'),
                    TextInput::make('ivr_menu_option_action')
                        ->label('Option Action')->placeholder('option action'),
                    TextInput::make('ivr_menu_option_param')
                        ->label('Option Param')->placeholder('option param'),
                    Textarea::make('ivr_menu_option_description')
                        ->label('Option Description')->rows(2)->columnSpanFull(),
                    ...
                    Tabs\Tab::make('Advanced')
                        ...
                        ->schema([
                            Section::make('Advanced')
                                ->columns(2)
                                ->schema([
                    TextInput::make('ivr_menu_option_order')
                        ->label('Option Order')
                        ->numeric(),
                                ]),
                        ]),
            ...
            Section::make('Record Info')
                ...
                ->collapsed()->columns(3)
                ->schema([
                    Placeholder::make('ivr_menu_uuid')
                        ->label('UUID')
