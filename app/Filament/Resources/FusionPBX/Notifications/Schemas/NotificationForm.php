...
namespace App\Filament\Resources\FusionPBX\Notifications\Schemas;
                    ...
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('project_notifications')
                        ->label('Project Notifications')->placeholder('project notifications'),
                                ]),
                        ]),
                ]),
