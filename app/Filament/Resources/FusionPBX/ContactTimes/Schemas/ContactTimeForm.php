...
namespace App\Filament\Resources\FusionPBX\ContactTimes\Schemas;
            ...
            Tabs::make('Contact Time')
                ...
                ->tabs([
                    ...
                    TextInput::make('time_start')
                        ->label('Time Start')->placeholder('time start'),
                    TextInput::make('time_stop')
                        ->label('Time Stop')->placeholder('time stop'),
                    Textarea::make('time_description')
                        ->label('Time Description')->rows(2)->columnSpanFull(),
                                ]),
                        ]),
                ]),
