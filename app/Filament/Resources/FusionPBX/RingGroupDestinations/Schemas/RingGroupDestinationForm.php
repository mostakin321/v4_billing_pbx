...
namespace App\Filament\Resources\FusionPBX\RingGroupDestinations\Schemas;
...
class RingGroupDestinationForm
{
    public static function configure(Schema $form): Schema
    {
        return $form->schema([

            Tabs::make('Ring Group Destination')
                ->columnSpanFull()
                ->tabs([
                    Tabs\Tab::make('Main')
                    ...
                    TextInput::make('destination_delay')
                        ->label('Destination Delay')->placeholder('destination delay'),
                    Select::make('destination_enabled')
                        ->label('Destination Enabled')
                        ->native(false)->options(['true'=>'Yes','false'=>'No'])->default('false'),
                    TextInput::make('destination_prompt')
                        ->label('Destination Prompt')->placeholder('destination prompt'),
