...
namespace App\Filament\Resources\FusionPBX\Streams\Schemas;
                    ...
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('stream_name')
                        ->label('Name')->placeholder('name'),
                    TextInput::make('stream_location')
                        ->label('Location')->placeholder('location'),
                    Select::make('stream_enabled')
                        ->label('Enabled')
                        ->native(false)->options(['true'=>'Yes','false'=>'No'])->default('false'),
                    Textarea::make('stream_description')
