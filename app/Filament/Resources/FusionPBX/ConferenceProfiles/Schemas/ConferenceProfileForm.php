...
namespace App\Filament\Resources\FusionPBX\ConferenceProfiles\Schemas;
...
class ConferenceProfileForm
{
    public static function configure(Schema $form): Schema
    {
        return $form->schema([

            Tabs::make('Conference Profile')
                ->columnSpanFull()
                ->tabs([
                    Tabs\Tab::make('Main')
