...
namespace App\Filament\Resources\FusionPBX\FifoMembers\Schemas;
...
class FifoMemberForm
{
    public static function configure(Schema $form): Schema
    {
        return $form->schema([

            Tabs::make('Fifo Member')
                ->columnSpanFull()
                ->tabs([
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('member_simultaneous')
                        ->label('Member Simultaneous')->placeholder('member simultaneous'),
                    TextInput::make('member_wrap_up_time')
                        ->label('Member Wrap Up Time')->placeholder('member wrap up time'),
                    Select::make('member_enabled')
                    ...
                    Tabs\Tab::make('Advanced')
                        ...
                        ->schema([
                            Section::make('Advanced')
                                ->columns(2)
                                ->schema([
                    TextInput::make('member_contact')
                        ->label('Member Contact')->placeholder('member contact'),
                    TextInput::make('member_call_timeout')
                        ->label('Member Call Timeout')
