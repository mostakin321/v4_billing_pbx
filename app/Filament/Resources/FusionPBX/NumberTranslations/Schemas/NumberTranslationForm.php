...
namespace App\Filament\Resources\FusionPBX\NumberTranslations\Schemas;
...
class NumberTranslationForm
{
    public static function configure(Schema $form): Schema
    {
        return $form->schema([

            Tabs::make('Number Translation')
                ->columnSpanFull()
                ->tabs([
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('number_translation_name')
                        ->label('Name')->placeholder('name'),
                    Select::make('number_translation_enabled')
                        ->label('Enabled')
                        ->native(false)->options(['true'=>'Yes','false'=>'No'])->default('false'),
                    Textarea::make('number_translation_description')
