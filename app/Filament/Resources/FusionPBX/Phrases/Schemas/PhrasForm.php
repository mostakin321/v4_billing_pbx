...
namespace App\Filament\Resources\FusionPBX\Phrases\Schemas;
                    ...
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('phrase_name')
                        ->label('Phrase Name')->placeholder('phrase name'),
                    Select::make('phrase_enabled')
                        ->label('Phrase Enabled')
                        ->native(false)->options(['true'=>'Yes','false'=>'No'])->default('false'),
                    Textarea::make('phrase_description')
                        ->label('Phrase Description')->rows(2)->columnSpanFull(),
                                ]),
                        ]),
                    ...
                    Tabs\Tab::make('Audio')
                        ...
                        ->schema([
                            Section::make('Audio')
                                ->columns(2)
                                ->schema([
                    TextInput::make('phrase_language')
                        ->label('Phrase Language')->placeholder('en'),
                                ]),
                        ]),
                ]),
