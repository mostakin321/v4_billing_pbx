...
namespace App\Filament\Resources\FusionPBX\DialplanTools\Schemas;
...
class DialplanToolForm
{
    public static function configure(Schema $form): Schema
    {
        return $form->schema([

            Tabs::make('Dialplan Tool')
                ->columnSpanFull()
                ->tabs([
                    Tabs\Tab::make('Main')
                    ...
                    TextInput::make('application')
                        ->label('Application')->placeholder('application'),
                    TextInput::make('data')
