...
namespace App\Filament\Resources\FusionPBX\VoicemailOptions\Schemas;
...
class VoicemailOptionForm
{
    public static function configure(Schema $form): Schema
    {
        return $form->schema([

            Tabs::make('Voicemail Option')
                ->columnSpanFull()
                ->tabs([
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    Textarea::make('voicemail_option_description')
                    ...
                    Tabs\Tab::make('Notifications')
                        ...
                        ->schema([
                            Section::make('Notifications')
                                ->columns(2)
                                ->schema([
                    TextInput::make('voicemail_option_digits')
                        ->label('Option Digits')->email(),
                    TextInput::make('voicemail_option_action')
                        ->label('Option Action')->email(),
                    TextInput::make('voicemail_option_param')
                        ->label('Option Param')->email(),
                                ]),
                        ]),
                    ...
                    Tabs\Tab::make('Advanced')
                        ...
                        ->schema([
                            Section::make('Advanced')
                                ->columns(2)
                                ->schema([
                    TextInput::make('voicemail_option_order')
                        ->label('Option Order')
                        ->numeric(),
                                ]),
                        ]),
