...
namespace App\Filament\Resources\FusionPBX\SipProfiles\Schemas;
                    ...
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    Select::make('sip_profile_enabled')
                        ->label('Enabled')
                        ->native(false)->options(['true'=>'Yes','false'=>'No'])->default('false'),
                    Textarea::make('sip_profile_description')
                    ...
                    Tabs\Tab::make('Advanced')
                        ...
                        ->schema([
                            Section::make('Advanced')
                                ->columns(2)
                                ->schema([
                    TextInput::make('sip_profile_name')
                        ->label('Name')->placeholder('name'),
                    TextInput::make('sip_profile_hostname')
