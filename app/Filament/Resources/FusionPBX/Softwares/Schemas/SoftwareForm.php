...
namespace App\Filament\Resources\FusionPBX\Softwares\Schemas;
            ...
            Tabs::make('Software')
                ...
                ->tabs([
                    ...
                    TextInput::make('software_name')
                        ->label('Software Name')->placeholder('software name'),
                    TextInput::make('software_url')
                        ->label('Software Url')->placeholder('software url'),
                    TextInput::make('software_version')
                        ->label('Software Version')->placeholder('software version'),
                                ]),
                        ]),
                ]),
