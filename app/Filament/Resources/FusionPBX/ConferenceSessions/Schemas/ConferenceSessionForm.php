...
namespace App\Filament\Resources\FusionPBX\ConferenceSessions\Schemas;
                    ...
                    Tabs\Tab::make('Audio')
                        ...
                        ->schema([
                            Section::make('Audio')
                                ->columns(2)
                                ->schema([
                    TextInput::make('recording')
                        ->label('Recording')->placeholder('recording'),
                                ]),
                        ]),
                ]),
