...
namespace App\Filament\Resources\FusionPBX\FollowMes\Schemas;
                    ...
                    Tabs\Tab::make('Main')
                        ...
                        ->schema([
                            Section::make('Main')
                                ->columns(2)
                                ->schema([
                    TextInput::make('dial_string')
                        ->label('Dial String')->placeholder('dial string'),
                    Select::make('follow_me_enabled')
                    ...
                    Tabs\Tab::make('Caller ID')
                        ...
                        ->schema([
                            Section::make('Caller ID')
                                ->columns(2)
                                ->schema([
                    TextInput::make('cid_name_prefix')
                        ->label('Cid Name Prefix')->placeholder('cid name prefix'),
                    TextInput::make('cid_number_prefix')
                        ->label('Cid Number Prefix')->placeholder('cid number prefix'),
                                ]),
                        ]),
                    ...
                    Tabs\Tab::make('Forwarding')
                        ...
                        ->schema([
                            Section::make('Forwarding')
                                ->columns(2)
                                ->schema([
                    TextInput::make('follow_me_ignore_busy')
                        ->label('Follow Me Ignore Busy')->placeholder('follow me ignore busy'),
                                ]),
                        ]),
                ]),
